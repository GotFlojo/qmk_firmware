...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NOTED_BASE] = LAYOUT_60_iso(
        KC_ESC,     KC_1,     KC_2,    KC_3,    KC_4,     KC_5,     KC_6,     KC_7,    KC_8,       KC_9,      KC_0,     DE_MINS,      NE_GRV,   KC_BSPC,
        KC_TAB,     DE_Z,     DE_Y,    DE_U,    DE_A,     DE_Q,     DE_P,     DE_B,    DE_M,       DE_L,      DE_F,     DE_J,        NE_ACUT,
        MO(SYMBOL), DE_C,     DE_S,    DE_I,    DE_E,     DE_O,     DE_D,     DE_T,    DE_N,       DE_R,      DE_H,     MO(SYMBOL),    DE_SS,    KC_ENT,
        KC_LSFT,    KC_NUBS,  DE_V,    DE_X,    DE_UDIA,  DE_ADIA,  DE_ODIA,  DE_W,    DE_G,    KC_COMM,    KC_DOT,     DE_K,            KC_RSFT,
        KC_LCTL,    KC_LWIN,  KC_LALT,                            KC_SPC,                          KC_RALT,   MO(KEY_MOUSE),    MO(_FN3), KC_RCTL),
